...
public sealed class AltRepo.Client : Object {
    ...
    public RepocopJsonGetList get_package_repocop (
        ...
        var bytes = soup_wrapper.get (
            ...
            null,
            {
                ...
                { "package_release", package_release.to_string () },
                { "bin_package_arch", bin_package_arch.to_string () },
                { "package_type", package_type.to_string () },
            },
            null,
            cancellable
    ...
    public SiteChangelog get_site_package_changelog_pkghash (
        ...
        var bytes = soup_wrapper.get (
            ...
            null,
            {
                { "changelog_last", changelog_last.to_string () },
            },
            null,
            cancellable
        );
    ...
    public TaskRepo get_task_task_repo_id (
        ...
        var bytes = soup_wrapper.get (
            ...
            null,
            {
                { "include_task_packages", include_task_packages.to_string () },
            },
            null,
            cancellable
        );

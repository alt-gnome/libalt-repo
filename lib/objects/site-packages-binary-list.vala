...
public class AltRepo.SitePackagesBinaryList : Object {
     ...
     */
    public Gee.ArrayList<SitePackagesBinaryListElement> packages { get; set; default = new Gee.ArrayList<SitePackagesBinaryListElement> (); }
